...
Original file is located at
    https://colab.research.google.com/drive/19swwUc6xlGDK_K1fFLc0sPPW9tGlD_ot
"""
...
from tensorflow.python.framework.ops import disable_eager_execution       #Change
...
def deprocess_image(x):
    ...
    x *= 255
    if K.image_data_format() == 'th':   #Change
        x = x.transpose((1, 2, 0))
...
def build_guided_model():
    ...
    g =tf.compat.v1.get_default_graph()                   #Change
    with g.gradient_override_map({'tanh': 'GuidedBackProp'}):
...
dir_path = r"C:\Users\Panday\Downloads\keras-gradcam-master\keras-gradcam-master/images/"
...
i = 3     #Changed from 63 to 12 due to "`IndexError: index 63 is out of bounds for axis 0 with size 36" Error
